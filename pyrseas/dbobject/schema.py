...
class Schema(DbObject):
    ...
    def extern_dir(self, root="."):
        ...
        """
        (dir, ext) = os.path.splitext(
            os.path.join(root, self.extern_filename())
        )
        return dir
        ...
        if opts.multiple_files:
            ...
            for obj, objmap in schobjs:
                if objmap is not None:
                    ...
                    outobj = {
                        extkey: os.path.relpath(filepath, opts.metadata_dir)
                    }
...
PREFIXES = {
    ...
    "function ": "functions",
    "aggregate ": "functions",
    "operator family ": "operfams",
    "operator class ": "operclasses",
    "conversion ": "conversions",
    "text search dictionary ": "tsdicts",
    "text search template ": "tstempls",
    "text search parser ": "tsparsers",
    "text search configuration ": "tsconfigs",
    "foreign table ": "ftables",
