...
class OwnerToSqlTestCase(InputMapToSqlTestCase):
    ...
    def test_create_function_default_args(self):
        ...
        assert (
            sql[2] == "ALTER FUNCTION sd.f1(integer, INOUT integer) "
    ...
    def test_change_table_owner_delim(self):
        ...
        sql = self.to_sql(
            ...
            [
                ...
                'CREATE TABLE "a-schema"."a-table" (' "c1 integer, c2 text)",
            ],
        )
        assert sql[0] == 'ALTER TABLE "a-schema"."a-table" OWNER TO ' "someuser"
